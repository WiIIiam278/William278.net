    ...
    fetch('/api/projects').then(projects => {
        ...
        fetchedProjects.forEach((project) => {
            if (project.documentation) {
                pluginElements += '<li><object class="docs-project-icon" data="/assets/icons/' + project.icon.svg + '" type="image/svg+xml"></object>&nbsp;<a href="/docs/' + project.name.toLowerCase() + '">' + project.name + '</a></li>'
            }
        });
        ...
        document.getElementById('docs-search').oninput = () => {
            ...
            fetch(query).then(results => {
                ...
                results.forEach((result) => {
                    ...
                    resultIcon.data = `/assets/icons/${project.icon.svg}`;
